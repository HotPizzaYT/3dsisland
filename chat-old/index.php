...
<html onload="hideMadeWith();">
  ...
  <head>
<meta content="The Chromebook Gang chat site. Chat now for free today, plus, you don't even have to login to do it! A remake of another chat. http://chromebookgang.000webhostapp.com/chat/chatss.png for a preview of the chat." name="description" />
<meta name="og:image" content="http://chromebookgang.000webhostapp.com/chat/chatss.png"/>
  <style>
  l {
  padding-left: 5px
  }
...
//  sendData(sendpost, getCookie("nickname"));
  ...
  <div style="position: absolute; width: 888px; height: 372px; z-index: 1; left: 20px; top: 51px" class="bg" id="layer1">
  <!-- Initiate chat refresh -->
  <div frameborder="0" style="background-color: white; position: absolute; width: 689px; height: 330px; z-index: 1; left: 5px; top: 7px; overflow-y: auto; overflow-x: hidden; padding-left: 8px;" src="innerchat.php" 
  
   id="chtDemoA" class="chatInner">
  
  
  
  
  </div>
  <div style="position: absolute; width: 857px; height: 30px; z-index: 1; left: 5px; top: 330px" id="layer3">
    <div style="background-color: white; position: absolute; width: 174px; height: 327px; z-index: 1; left: 703px; top: -324px; overflow-y: scroll" id="layer4">
